...
"Point of origin" might be different from "Home". "Home" is defined as position at the time of arming. While "Point of origin" is recorded after a valid GPS fix is acquired.
...
* [blackbox_decode](https://github.com/iNavFlight/blackbox-tools) Decode to CSV file
...
|  time (us) 	    |  x-axis of diagram 	|  real time in microseconds 	|   	|   |sensors/acceleration.h
