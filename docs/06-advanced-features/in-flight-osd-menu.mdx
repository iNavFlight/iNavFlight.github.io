...
:::warning
Modifying parameters during flight carries inherent risk. Only make adjustments while in a stable cruise/loiter phase with plenty of altitude and airspace. Changes to PIDs or rates can affect flight behaviour immediately.
:::
...
:::important
A **latching switch** is required. The menu stays open only while the switch is held in the active position. Toggling the switch off closes the menu immediately and restores full stick control.
:::
