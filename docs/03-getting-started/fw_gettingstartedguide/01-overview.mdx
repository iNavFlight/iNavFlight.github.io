...
INAV has the ability to fly many different kinds of airplanes. 
There are conventional high wing/low wing, flying wings, electric ducted fan jets, sailplanes, multi motor configurations, differential thrust setups, and more. 
...
FPV platforms with large batteries may not always result in significantly longer flight times as the airframe will be fighting the additional weight. 
