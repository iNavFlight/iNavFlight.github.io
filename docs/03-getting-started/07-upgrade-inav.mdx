...
- The first number is the major version, which indicates compatibility. Any 9.x.y version of Configurator is compatible with any 9.a.b version of INAV. Third-party GS or other software should also be compatible across any revision within a major version.
