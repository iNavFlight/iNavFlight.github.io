---
title: VTX
description: Setting up VTXs
---
## Digital Systems

![Digital VTX](/img/features-core/vtx-digital.png)

Digital systems get their information through MSP.
To configure a digital system such as Caddx Walksnail, DJI, and Betafpv P1, go to the Ports tab and under Peripherals, select MSP Displayport.
Ensure the UART connection from the FC to the VTX is connected to the selected port (UART 5 in the example above).

## Analog VTX

INAV supports IRC Tramp and TBS SmartAudio protocols for controlling analog VTXs.
To enable it, select IRC or TBS SmartAudio under Peripherals as seen in the image above.
Once selected, the option to change the band and channel will appear in the Configuration Tab.

### IRC Tramp 1G3SE Setup
