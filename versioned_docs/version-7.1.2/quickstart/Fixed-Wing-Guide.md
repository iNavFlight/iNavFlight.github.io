...
* Set your [RTH mode](../features/Navigation-modes.md#rth---return-to-home) to your liking
...
* Arm and launch your aircraft using prefered mode, example `manual` for the maiden flight launch.
    * If airplane is not flying leveled when in self leveling mode like `Horizon` you need to trim your [board aligment](./Calibration-Tab.md#accelerometer-calibration-steps)
    * If airplane flies leveled, do an [Servo Autotrim](../features/Modes.md#auto-level-trim-fw)
