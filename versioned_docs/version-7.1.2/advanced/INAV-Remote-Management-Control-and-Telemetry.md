...
[INAV Wiki MSPV2 definition](./MSP-V2.md).

[INAV Wiki MSP Navigation Messages](./MSP-Navigation-Messages.md). Detailed explanation of the usage of INAV / MSP Way point definitions.
...
There is also a long abandoned (alas) [changelog](./INAV-MSP-frames-changelog.md) of historic interest only.
...
* [Building custom INAV](./Building-custom-firmware.md).
* [Developer Info / Navigation internals](./Developer-info.md)
