...
There are many different modes for Altitude, see the [RTH mode page](../advanced/Navigation-Mode:-Return-to-Home.md) for details.
...
![](/img/content/nav_modes_diagram.jpg)
